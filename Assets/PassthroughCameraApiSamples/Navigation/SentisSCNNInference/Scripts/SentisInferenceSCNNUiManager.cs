...
namespace PassthroughCameraSamples.MultiObjectDetection
{
    ...
    public class SentisInferenceSCNNUiManager : MonoBehaviour
    {
        ...
        public void DrawUIBoxes(Tensor<float> output, Tensor<int> labelIDs, float imageWidth, float imageHeight, Pose cameraPose)
        {
            ...
            for (var n = 0; n < maxBoxes; n++)
            {
                ...
                var box = new BoundingBox
                {
                    ...
                    Width = width,
                    Height = height,
                    Distance = distanceMeters.HasValue ? distanceMeters.Value : -1f,
                ...
                if (panel == null)
                {
                    ...
                    panel = CreateNewBox(boxColorInit);
        ...
        {
            // Clamp distance between 0 and 3
            float d = Mathf.Clamp(distance, 0f, 3f);
